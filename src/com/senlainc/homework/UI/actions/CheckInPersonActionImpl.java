...
public class CheckInPersonActionImpl implements Action {
    private static LoggerService logger = new LoggerServiceImpl();

    @Override
    public void execute() {
        try {
            System.out.println("Input id person, room number, days count");
            Scanner scanner = new Scanner(System.in);
            ControllerImpl.getInstance().checkInPerson(scanner.nextInt(), scanner.nextInt(), scanner.nextInt());
